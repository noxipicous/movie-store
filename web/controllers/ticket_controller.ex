defmodule MovieStore.TicketController do
  ...
  def create(conn, %{"ticket" => ticket_params}) do
    ...
    case Repo.insert(changeset) do
      {:ok, ticket} ->
        # since we processed a ticket purchase, let's notify the channel clients
        # MovieStore.TicketChannel.
        MovieStore.Endpoint.broadcast! "tickets:lobby", "new_ticket_purchase", %{body: %{movie: ticket.id, quantity: ticket.quantity}}
        conn
